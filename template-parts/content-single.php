        ...
        <div class="card_body">
            <div>
                ...
                if ('post' === get_post_type()) :
                    ...
                    if(get_field('url')){    ?><a class="btn tilyafov cta" title="<?php the_field('url'); ?>"  href="<?php the_field("url"); ?>">Sokafy <i class="fa-solid fa-right-to-bracket"></i></a> <?php } //end if get_field ?>
                    </div><!-- .entry-meta -->
                <?php endif; ?>
            </div>
